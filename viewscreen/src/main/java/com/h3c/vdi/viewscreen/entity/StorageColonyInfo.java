...
@NoArgsConstructor
@Entity
@Table(name = "tbl_storage_colony_info")
@Accessors(chain = true)
public class StorageColonyInfo implements Serializable {
    ...
    @Column(name = "iops_percent")
    private Integer iopsPercent;

    @Column(name = "io_throughput_capacity")
    private Integer ioThroughputCapacity;
